...
st.header("Show chart Gender and Color")
chart_data=pd.read_csv("./Data/shopping22.csv")
group_age = df.groupby(['Color', 'Gender']).size().reset_index(name='count')
st.bar_chart(group_age, x='Color', y='count', color='Gender', height=400)
