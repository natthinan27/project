...
st.bar_chart(group_age, x='Item Purchased', y='count', color=alt.Color('Gender:N', scale=alt.Scale(range=['blue', 'red'])), height=400, use_container_width=True, theme="streamlit")
