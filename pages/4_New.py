...
grouped_data = df.groupby(['Gender', 'Color']).size().reset_index(name='count')
pivot_table = pd.pivot_table(grouped_data, values='count', index='Gender', columns='Color', fill_value=0)
