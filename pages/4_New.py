...
grouped_data = df.groupby(['Season', 'Color']).size().reset_index(name='count')
pivot_table = pd.pivot_table(grouped_data, values='count', index='Season', columns='Color', fill_value=0)
